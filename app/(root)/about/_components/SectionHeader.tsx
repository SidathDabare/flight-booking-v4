...
export function SectionHeader({
  ...
  return (
    <div className={`mb-12 sm:mb-16 lg:mb-20 ${containerClass} ${alignClass}`}>
      <span className="inline-block px-3 sm:px-4 py-1.5 sm:py-2 bg-gradient-to-r from-amber-100 to-orange-100 dark:from-amber-900/30 dark:to-orange-900/30 rounded-full text-xs sm:text-sm font-semibold text-amber-700 dark:text-amber-400 mb-4 shadow-sm">
        {badge}
      </span>
      <h2
