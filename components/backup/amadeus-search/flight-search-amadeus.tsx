...
import AutocompleteAmadeus from "./AutocompleteAmadeus";
import { useState, useEffect } from "react";
import DatePickerWithRange from "./DateRangePicker";
import LoadingScreen from "@/components/ui/loading-screen";

import { getCurrencyCode } from "@/lib/utils/currency";
import { ClientCarousel } from "@/components/custom ui/ClientCarousel";
...
export default function FlightSearchAmadeus() {
  ...
  return (
    <div className="w-full relative h-screen min:h-screen mt-[-65px]">
      {/* Background Carousel */}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-2  sm:gap-1 md:gap-3 mb-1 sm:mb-1 md:mb-0 py-2 items-center">
                    ...
                    <Popover>
                      <PopoverTrigger asChild>
                        <Button
                          variant="outline"
                          className="w-full sm:w-50 h-[57px] border border-gray-300 hover:border-blue-600 focus:border-blue-500 rounded-none bg-transparent hover:bg-transparent hover:text-white"
                        >
                          {form.watch("adults") +
                            form.watch("children") +
                            form.watch("infants")}{" "}
                    ...
                    <div className="flex justify-end items-center">
                      <Button
                        ...
                        className={`w-full min-w-0 sm:min-w-[200px] h-[48px] sm:h-[57px] text-base rounded-none ${
                          isDisabled
