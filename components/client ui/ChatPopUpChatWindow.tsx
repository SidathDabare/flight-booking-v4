...
export function ChatPopUpChatWindow({
  messageId,
  onBack,
  ...
  return (
    <>
      <div className="flex flex-col h-full relative">
        ...
        <div
          className="bg-gray-50 p-4 max-h-[400px] md:max-h-[400px] min-h-[280px] pb-16"
          style={{
            backgroundImage:
        ...
        >
          <div
            ref={scrollRef}
            className="max-w-4xl mx-auto h-full overflow-y-auto"
          >
