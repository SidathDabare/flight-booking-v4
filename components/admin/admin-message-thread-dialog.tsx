...
export function AdminMessageThreadDialog({ message: initialMessage, open, onClose }: AdminMessageThreadDialogProps) {
  ...
  const getRoleBadge = (role: string) => {
    const roleConfig = {
      client: { label: "Client", className: "" },
      agent: { label: "Agent", className: "" },
        ...
        {isLoading ? (
          ...
          <>
            ...
            <div className="flex items-center gap-2">
              ...
              {message.status !== "pending" && message.status !== "closed" && (
                <div className="flex items-center gap-2">
                  <Select
            ...
            {/* Reply Section */}
            {message.status === "pending" && (
              <div className="text-center py-3 text-sm rounded-lg">
