...
export function AgentMessagesWhatsApp() {
  ...
  const filteredMessages = messages.filter((msg) => {
    ...
    if (filterMode === "pending") {
      passesFilter = msg.status === "pending";
    } else if (filterMode === "myMessages") {
      passesFilter = msg.assignedTo === session?.user?.id;
    }
  ...
  const getMyMessagesCount = () =>
    messages.filter((m) => m.assignedTo === session?.user?.id).length;
        ...
        >
          ...
          <div className="p-4 border-b border-gray-200 space-y-3">
            <div className="flex items-center justify-between">
              <h1 className="text-xl font-bold">Agent Messages</h1>
              <Button
                size="icon"
                variant="outline"
                ...
                <p className="text-sm text-gray-500">
                  {searchQuery
                    ...
                    : filterMode === "pending"
                      ...
                      : filterMode === "myMessages"
                        ? "Accept messages to see them here"
              ...
              filteredMessages.map((message) => {
                ...
                return (
                  <AgentConversationItem
                    ...
                    isAssignedToMe={message.assignedTo === session?.user?.id}
            ...
            <div className="flex-1 flex items-center justify-center bg-gray-50">
              <div className="text-center">
                ...
                <div className="text-sm text-gray-500">
                  <p>
                    💡 Tip: Accept pending messages to add them to &quot;My
                    Messages&quot;
                  </p>
                </div>
              </div>
