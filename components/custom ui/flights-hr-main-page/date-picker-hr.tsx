...
export default function DatePickerHr({
  departureDate,
  returnDate,
  className,
  getDateValue,
  ...
  const renderCalendar = React.useCallback(
    (date: Date) => {
      ...
      return (
        <div className="w-full p-6 border dark:border-gray-700">
          ...
          <div className="grid grid-cols-7 gap-0 text-gray-500 dark:text-gray-400">
            {days.map((day, index) => {
              if (!day) {
                ...
                <Button
                  ...
                  className={cn(
                    ...
                    "hover:bg-gray-300 hover:text-gray-900",
                    {
                      ...
                      "bg-blue-500/80 text-gray-100 font-semibold rounded-none":
                        isToday && !isSelected,
  ...
  return (
    <div ref={containerRef} className={cn("w-full relative", className)}>
        ...
        <div className="flex items-center justify-between h-full relative">
          <div className="flex-1 w-[80%]">
            {formatDisplayValue() ? (
              ...
              <span className="text-sm text-gray-500">{t("pickDate")}</span>
            )}
          </div>
      ...
      {isOpen && (
        <div
          className="fixed bg-white dark:bg-gray-900 rounded-lg shadow-2xl border border-gray-200 dark:border-gray-700 w-[320px] max-h-96 overflow-visible"
          style={dropdownStyle}
        >
          <div className="relative">
            <Button
              ...
              className="absolute left-2 top-6 z-10 h-8 w-8 border text-gray-400 border-gray-400 bg-white hover:bg-gray-50 flex items-center justify-center p-0"
            >
            ...
            <Button
              ...
              className="absolute right-2 top-6 z-10 h-8 w-8 border text-gray-400 border-gray-400 bg-white hover:bg-gray-50 flex items-center justify-center p-0"
            >
